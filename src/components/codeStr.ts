...
export const codeStr = (looks: Item[][]) => {
  ...
  const map = looks.map((look, index) => (`
    <li id="area${index + 1}">
      <div>
        <ul>
          <li><img src="/img/${index + 1}_1.jpg" alt="" width="690" height="970"></li>
          <li><img src="/img/${index + 1}_2.jpg" alt="" width="690" height="970"></li>
          <li><img src="/img/${index + 1}_3.jpg" alt="" width="690" height="970"></li>
          <li><img src="/img/${index + 1}_4.jpg" alt="" width="690" height="970"></li>
        </ul>
      </div>
